...
if(isset($_POST["verifyemail"]))
{
	...
	if($sotp == $otp )
	{
		...
		$subject='WELCOME';
		$message='SportzStrefa welcomes you to our online sports store.Get all the sports item at our website.Happy Shopping';
	...
	<div class="login-page">
		<div class="container"> 
			...
			<div class="login-body">
				...
				<p>We have sent a verification OTP to your Email provided</p>
