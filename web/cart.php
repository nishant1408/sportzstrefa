			...
			<div class="single-page">
				...
				$error=0;
					...
					<form action="product_details.php?product_id=<?=$product_id?>" method="post">
							<button type="submit" class="w3ls-cart" style="width:160px" ><i class="fa " aria-hidden="true"></i>View Product</button>
						</form>
						</div>
						<div class="col-md-4">
						<form action="cart.php" method="post">
						<input type="hidden" name="delete" value="<?=$product_id?>" >
							<button type="submit" class="w3ls-cart" style="width:200px" ><i class="fa " aria-hidden="true"></i>Remove From cart</button>
						</form>
						</div>
						<div class="col-md-3">
						<form action="cart.php" method="post">
						<input type="hidden" name="addwishlist" value="<?=$product_id?>" >
							<button type="submit" class="w3ls-cart" style="width:200px" ><i class="fa " aria-hidden="true"></i>Add to Wishlist</button>
						</form>
						</div>
						<?php
					echo "</div>";
