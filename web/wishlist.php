...
$selectname="SELECT name FROM userinfo WHERE user_id='$user_id' ";
				...
				<?php
					...
					<form action="product_details.php?product_id=<?=$product_id?>" method="post">
						...
						<input type="hidden" name="delete" value="<?=$product_id?>" >
							<button type="submit" class="w3ls-cart" style="width:200px" ><i class="fa " aria-hidden="true"></i>Remove From Wishlist</button>
						</form>
						</div>
						<?php
					echo "</div>";
