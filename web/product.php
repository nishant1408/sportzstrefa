...
if($filter=="NO")
{
	if($type=="ALL")
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND verify='1'";
	}
	else
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND type='$type' AND verify='1' ";
	}
}
else if($filter=="LOW")
{
	if($type=="ALL")
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND verify='1' ORDER BY show_price ASC ";
	}
	else
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND type='$type' AND verify='1' ORDER BY show_price ASC ";
	}
}
else if($filter=="HIGH")
{
	if($type=="ALL")
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND verify='1' ORDER BY show_price DESC ";
	}
	else
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND type='$type' AND verify='1' ORDER BY show_price DESC ";
	}
}
else if($filter=="RATE")
{
	if($type=="ALL")
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND verify='1' ORDER BY rate DESC ";
	}
	else
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND type='$type' AND verify='1' ORDER BY rate DESC ";
	}
}
else if($filter=="VIEW")
{
	if($type=="ALL")
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND verify='1' ORDER BY views DESC ";
	}
	else
	{
		$query="SELECT * FROM product_details WHERE sports='$sports' AND type='$type' AND verify='1' ORDER BY views DESC ";
	}
}
?>
					...
					<ul> 
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								<li><a href="product.php?sports=<?=$sports?>&type=<?=$type?>&filter=LOW">Low price First</a></li> 
								<li><a href="product.php?sports=<?=$sports?>&type=<?=$type?>&filter=HIGH">High price First</a></li>
								<li><a href="product.php?sports=<?=$sports?>&type=<?=$type?>&filter=RATE">By rating</a></li> 
								<li><a href="product.php?sports=<?=$sports?>&type=<?=$type?>&filter=VIEW">By Popularity</a></li> 
							</ul> 
						</li>
					</ul> 
					<div class="clearfix"> </div>
			...
			<div class="col-md-3 rsidebar">
				<div class="rsidebar-top">
					...
					<div class="sidebar-row" >
						...
						<form id="formname" action="product.php?sports=<?=$sports?>&type=<?=$type?>&filter=<?=$filter?>" method="post" >
						<br>
