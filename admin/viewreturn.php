...
<h4><b><u>All Return Order Details</u></b></h4>
<a href="downloadviewreturn.php">DOWNLOAD LIST</a>
<?php

$value='Return in Process';
$query = "SELECT * FROM track_order WHERE status='$value' ORDER BY order_id DESC ";
?>
