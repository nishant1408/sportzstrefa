...
<div class="form-style-2-heading">Delete Product</div>
<form action="deleteproduct.php" method="post" onsubmit="alert('THIS ACTION CAN NOT BE UNDONE. PRESS OK TO CONTINUE .');">
<p>Your Product ID:</p>
<label for="field1"><span><font color="#ff0000"><span class="required"></span></span><input type="text" class="input-field" name="product_id" value="" required/></label>




<label><span>&nbsp;</span><input type="submit" value="Delete Product" /></label>
</form>
</body>
	</div>	
</div>
