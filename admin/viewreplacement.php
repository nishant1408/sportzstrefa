...
<h4><b><u>All Replacement Order Details</u></b></h4>
<a href="downloadviewreplacement.php">DOWNLOAD LIST</a>
<?php

$value='Replacement in Process';
$query = "SELECT order_id,name,mobile,email,product_name,product_id,price,address,city,state,landmark,pincode,coupon_code,status, payment,dcharge,total FROM track_order WHERE status='$value' ORDER BY id DESC ";
?>
