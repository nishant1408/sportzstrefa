...
<div class="form-style-2-heading">Verify Product</div>
<form action="verify/product_details.php" method="post" >
<p>Your Product ID:</p>
...
<label><span>&nbsp;</span><input type="submit" value="Update Product" /></label>
</form>
</body>
	</div>	
</div>
