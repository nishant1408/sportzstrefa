		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<select class="form-control bfh-states" name="quantity" required>
					...
					<?php
							...
							{
								?>
					<select class="form-control bfh-states" name="size" required>
			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
						...
						<div class="flexslider" >
							<ul class="slides">
								<li data-thumb="../admin/images/<?php echo $pic1 ?>">
									<div class="thumb-image detail_images"> <img src="../admin/images/<?php echo $pic1 ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<?php
								if($pic2!="")
								{
								...
								<li data-thumb="../admin/images/<?php echo $pic2 ?>">
									 <div class="thumb-image"> <img src="../admin/images/<?php echo $pic2 ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic3 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic3 ?>" data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic4 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic4 ?>"  data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic5 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic5 ?>" data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic6 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic6 ?>" data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic7 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic7 ?>" data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
								...
								<li data-thumb="../admin/images/<?php echo $pic8 ?>">
								   <div class="thumb-image"> <img src="../admin/images/<?php echo $pic8 ?>"  data-imagezoom="true" class="img-responsive" alt="" > </div>
								</li>
								<?php
								}
								?>
					...
					<div class="col-md-6 single-top-right" >
						...
						if($return_type=="YES")
						{
							echo "<p><font size='5'>".$return_day." Days Replacement Policy</p>";
							echo "<p><font size='5'>Returns Accepted</p>";
						}
						else
						{
