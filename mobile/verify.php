...
$selectname="SELECT * FROM userinfo WHERE user_id='$user_id' AND verify='0'";
...
if(isset($_POST["verifyemail"]))
{
	...
	if($sotp == $otp )
	{
		$update="UPDATE userinfo SET verify='1' WHERE user_id='$user_id' ";
		...
		$subject="WELCOME";
		$message="<b>SportzStrefa welcomes you to our online sports store.<br>Get all the sports item at our website.<br>Happy Shopping.<br></b><img src='http://sportstrefa.tk/images/welcome.jpg'>";
...
<body>
	...
	<div class="login-page">
		<div class="container"> 
			...
			<h6>Incorrect Details? <a href="edit.php">Try Again »</a> </h6> 			
		</div>
	</div>
	<!-- //sign up-page --> 
	<!-- footer-top -->
